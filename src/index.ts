import { create, createS, useHooks, watch, deepWatch, link, deepLink, setDebugComponentName } from './func';
...
export { state, stateV, stateLongArray, create, createS, useHooks, watch, deepWatch, link, deepLink };
